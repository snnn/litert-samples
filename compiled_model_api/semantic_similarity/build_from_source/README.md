...
1. **Build the project:**
   ```bash
   bazel build -c opt //compiled_model_api/semantic_similarity/build_from_source:semantic_similarity
   ```
2. **Run the application:**
   ```bash
   ./bazel-bin/compiled_model_api/semantic_similarity/build_from_source/semantic_similarity \
